...
public final class ActivityTrainingAiCameraBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ActivityTrainingAiCameraBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityTrainingAiCameraBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_training_ai_camera, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityTrainingAiCameraBinding bind(@NonNull View rootView) {
