...
public final class SelectedTrainListBinding implements ViewBinding {
  ...
  @NonNull
  public static SelectedTrainListBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static SelectedTrainListBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.selected_train_list, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static SelectedTrainListBinding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.list_image;
      ImageView listImage = ViewBindings.findChildViewById(rootView, id);
      if (listImage == null) {
        break missingId;
      }
