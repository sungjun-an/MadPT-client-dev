...
class LoadRecyclerAdapter(private val storeTrainList: ArrayList<storeTraining>, listen:OnItemClickListener): RecyclerView.Adapter<LoadRecyclerAdapter.ViewHolder>() {

    private val listen = listen

    inner class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        private val trainTitle = itemView.findViewById<TextView>(R.id.load_train_title)
        fun bind(data: storeTraining){
            trainTitle.text = data.routineTitle
        }
    }
